...
def load_model():
    model = AutoModelForQuestionAnswering.from_pretrained('C:/Users/omuku/OneDrive/Desktop/Capstone Project/Cuad Models/roberta-base')
    tokenizer = AutoTokenizer.from_pretrained('C:/Users/omuku/OneDrive/Desktop/Capstone Project/Cuad Models/roberta-base', use_fast=False)
...
if (not len(paragraph)==0) and not (len(question)==0):
    ...
    prediction = prediction(question, paragraph, 'C:/Users/omuku/OneDrive/Desktop/Capstone Project/Cuad Models/roberta-base/')
